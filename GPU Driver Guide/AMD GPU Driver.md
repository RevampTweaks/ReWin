...
1. Run [`AMD Control Panel Post Cleanup.ps1`](../Scripts/AMD%20Control%20Panel%20Post%20Cleanup.ps1) to remove unnecessary AMD Control Panel registry entries and scheduled tasks. (Only if you installed the Control Panel)
